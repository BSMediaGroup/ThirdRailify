        ...
        {configured && !message && !oauthProvider && (
          <>
            ...
            <form className="auth-form" onSubmit={submit}>
              ...
              {mode !== "forgot" && (
                <label className="auth-field"><span>Password</span><span className="auth-password"><input ref={mode === "reset" ? initialField : undefined} name="password" type={showPassword ? "text" : "password"} autoComplete={mode === "signin" ? "current-password" : "new-password"} minLength={12} maxLength={256} required /><button type="button" onClick={() => setShowPassword((value) => !value)}>{showPassword ? "Hide" : "Show"}</button></span></label>
              )}
